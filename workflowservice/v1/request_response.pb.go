...
type GetWorkflowExecutionResultRequest struct {
	...
	Execution *v13.WorkflowExecution `protobuf:"bytes,2,opt,name=execution,proto3" json:"execution,omitempty"`
	// A unique identifier for this request for idempotence. Typically UUIDv4.
	...
	CompletionCallbacks []*v13.Callback `protobuf:"bytes,5,rep,name=completion_callbacks,json=completionCallbacks,proto3" json:"completion_callbacks,omitempty"`
	...
	Links         []*v13.Link `protobuf:"bytes,6,rep,name=links,proto3" json:"links,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetWorkflowExecutionResultRequest) GetExecution() *v13.WorkflowExecution {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *GetWorkflowExecutionResultRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *GetWorkflowExecutionResultRequest) GetIdentity() string {
	if x != nil {
		return x.Identity
	}
	return ""
...
func (x *GetWorkflowExecutionResultRequest) GetCompletionCallbacks() []*v13.Callback {
	if x != nil {
		return x.CompletionCallbacks
	}
	return nil
...
func (x *GetWorkflowExecutionResultRequest) GetLinks() []*v13.Link {
	if x != nil {
		return x.Links
	}
	return nil
...
type GetWorkflowExecutionResultResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Information about the workflow execution, including the runID that this result is associated to.
	Execution *v13.WorkflowExecution `protobuf:"bytes,1,opt,name=execution,proto3" json:"execution,omitempty"`
	...
	Links []*v13.Link `protobuf:"bytes,2,rep,name=links,proto3" json:"links,omitempty"`
	...
	//
	//	*GetWorkflowExecutionResultResponse_Running_
	//	*GetWorkflowExecutionResultResponse_Success_
	//	*GetWorkflowExecutionResultResponse_Failed_
...
func (x *GetWorkflowExecutionResultResponse) GetExecution() *v13.WorkflowExecution {
	if x != nil {
		return x.Execution
	}
	return nil
...
func (x *GetWorkflowExecutionResultResponse) GetLinks() []*v13.Link {
	if x != nil {
		return x.Links
	}
	return nil
...
func (x *GetWorkflowExecutionResultResponse) GetRunning() *GetWorkflowExecutionResultResponse_Running {
	if x != nil {
		if x, ok := x.CompletionStatus.(*GetWorkflowExecutionResultResponse_Running_); ok {
			return x.Running
		}
	}
	return nil
...
func (x *GetWorkflowExecutionResultResponse) GetSuccess() *GetWorkflowExecutionResultResponse_Success {
	if x != nil {
		if x, ok := x.CompletionStatus.(*GetWorkflowExecutionResultResponse_Success_); ok {
			return x.Success
		}
	}
	return nil
...
func (x *GetWorkflowExecutionResultResponse) GetFailed() *GetWorkflowExecutionResultResponse_Failed {
	if x != nil {
		if x, ok := x.CompletionStatus.(*GetWorkflowExecutionResultResponse_Failed_); ok {
			return x.Failed
		}
	}
	return nil
...
type GetWorkflowExecutionResultResponse_Running_ struct {
	Running *GetWorkflowExecutionResultResponse_Running `protobuf:"bytes,3,opt,name=running,proto3,oneof"`
}

type GetWorkflowExecutionResultResponse_Success_ struct {
	Success *GetWorkflowExecutionResultResponse_Success `protobuf:"bytes,4,opt,name=success,proto3,oneof"`
}

type GetWorkflowExecutionResultResponse_Failed_ struct {
	Failed *GetWorkflowExecutionResultResponse_Failed `protobuf:"bytes,5,opt,name=failed,proto3,oneof"`
}

func (*GetWorkflowExecutionResultResponse_Running_) isGetWorkflowExecutionResultResponse_CompletionStatus() {
}

func (*GetWorkflowExecutionResultResponse_Success_) isGetWorkflowExecutionResultResponse_CompletionStatus() {
}

func (*GetWorkflowExecutionResultResponse_Failed_) isGetWorkflowExecutionResultResponse_CompletionStatus() {
}
...
type GetWorkflowExecutionResultResponse_Running struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWorkflowExecutionResultResponse_Running) Reset() {
	*x = GetWorkflowExecutionResultResponse_Running{}
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[250]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWorkflowExecutionResultResponse_Running) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWorkflowExecutionResultResponse_Running) ProtoMessage() {}

func (x *GetWorkflowExecutionResultResponse_Running) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[250]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWorkflowExecutionResultResponse_Running.ProtoReflect.Descriptor instead.
func (*GetWorkflowExecutionResultResponse_Running) Descriptor() ([]byte, []int) {
	return file_temporal_api_workflowservice_v1_request_response_proto_rawDescGZIP(), []int{77, 0}
}

type GetWorkflowExecutionResultResponse_Success struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        *v13.Payloads          `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWorkflowExecutionResultResponse_Success) Reset() {
	*x = GetWorkflowExecutionResultResponse_Success{}
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[251]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWorkflowExecutionResultResponse_Success) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWorkflowExecutionResultResponse_Success) ProtoMessage() {}

func (x *GetWorkflowExecutionResultResponse_Success) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[251]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWorkflowExecutionResultResponse_Success.ProtoReflect.Descriptor instead.
func (*GetWorkflowExecutionResultResponse_Success) Descriptor() ([]byte, []int) {
	return file_temporal_api_workflowservice_v1_request_response_proto_rawDescGZIP(), []int{77, 1}
}

func (x *GetWorkflowExecutionResultResponse_Success) GetResult() *v13.Payloads {
	if x != nil {
		return x.Result
	}
	return nil
...
type GetWorkflowExecutionResultResponse_Failed struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetWorkflowExecutionResultResponse_Failed) Reset() {
	*x = GetWorkflowExecutionResultResponse_Failed{}
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[252]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWorkflowExecutionResultResponse_Failed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWorkflowExecutionResultResponse_Failed) ProtoMessage() {}

func (x *GetWorkflowExecutionResultResponse_Failed) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[252]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWorkflowExecutionResultResponse_Failed.ProtoReflect.Descriptor instead.
func (*GetWorkflowExecutionResultResponse_Failed) Descriptor() ([]byte, []int) {
	return file_temporal_api_workflowservice_v1_request_response_proto_rawDescGZIP(), []int{77, 2}
}

func (x *GetWorkflowExecutionResultResponse_Failed) GetFailure() *v15.Failure {
	if x != nil {
		return x.Failure
	}
	return nil
...
const file_temporal_api_workflowservice_v1_request_response_proto_rawDesc = "" +
	...
	"\x16workflow_extended_info\x18\b \x01(\v27.temporal.api.workflow.v1.WorkflowExecutionExtendedInfoR\x14workflowExtendedInfo\"\xce\x02\n" +
	"!GetWorkflowExecutionResultRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12G\n" +
	"\texecution\x18\x02 \x01(\v2).temporal.api.common.v1.WorkflowExecutionR\texecution\x12\x1d\n" +
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId\x12\x1a\n" +
	"\bidentity\x18\x04 \x01(\tR\bidentity\x12S\n" +
	"\x14completion_callbacks\x18\x05 \x03(\v2 .temporal.api.common.v1.CallbackR\x13completionCallbacks\x122\n" +
	"\x05links\x18\x06 \x03(\v2\x1c.temporal.api.common.v1.LinkR\x05links\"\x84\x05\n" +
	"\"GetWorkflowExecutionResultResponse\x12G\n" +
	"\texecution\x18\x01 \x01(\v2).temporal.api.common.v1.WorkflowExecutionR\texecution\x122\n" +
	"\x05links\x18\x02 \x03(\v2\x1c.temporal.api.common.v1.LinkR\x05links\x12g\n" +
	"\arunning\x18\x03 \x01(\v2K.temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.RunningH\x00R\arunning\x12g\n" +
	"\asuccess\x18\x04 \x01(\v2K.temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.SuccessH\x00R\asuccess\x12d\n" +
	"\x06failed\x18\x05 \x01(\v2J.temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.FailedH\x00R\x06failed\x1a\t\n" +
	"\aRunning\x1aC\n" +
	"\aSuccess\x128\n" +
	"\x06result\x18\x01 \x01(\v2 .temporal.api.common.v1.PayloadsR\x06result\x1aD\n" +
	"\x06Failed\x12:\n" +
	"\afailure\x18\x01 \x01(\v2 .temporal.api.failure.v1.FailureR\afailureB\x13\n" +
	"\x11completion_status\"\xb2\x05\n" +
...
var file_temporal_api_workflowservice_v1_request_response_proto_msgTypes = make([]protoimpl.MessageInfo, 281)
var file_temporal_api_workflowservice_v1_request_response_proto_goTypes = []any{
	...
	(*GetWorkflowExecutionResultRequest)(nil),                    // 76: temporal.api.workflowservice.v1.GetWorkflowExecutionResultRequest
	(*GetWorkflowExecutionResultResponse)(nil),                   // 77: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse
	...
	nil, // 244: temporal.api.workflowservice.v1.RegisterNamespaceRequest.DataEntry
	nil, // 245: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry
	nil, // 246: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.QueryResultsEntry
	(*RespondWorkflowTaskCompletedRequest_Capabilities)(nil), // 247: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.Capabilities
	(*CountWorkflowExecutionsResponse_AggregationGroup)(nil), // 248: temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse.AggregationGroup
	nil, // 249: temporal.api.workflowservice.v1.GetSearchAttributesResponse.KeysEntry
	(*GetWorkflowExecutionResultResponse_Running)(nil), // 250: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Running
	(*GetWorkflowExecutionResultResponse_Success)(nil), // 251: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Success
	(*GetWorkflowExecutionResultResponse_Failed)(nil),  // 252: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Failed
	nil, // 253: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.StatsByPriorityKeyEntry
	(*DescribeTaskQueueResponse_EffectiveRateLimit)(nil), // 254: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.EffectiveRateLimit
	nil, // 255: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.VersionsInfoEntry
	nil, // 256: temporal.api.workflowservice.v1.GetClusterInfoResponse.SupportedClientsEntry
	(*GetSystemInfoResponse_Capabilities)(nil),                                      // 257: temporal.api.workflowservice.v1.GetSystemInfoResponse.Capabilities
	(*CountSchedulesResponse_AggregationGroup)(nil),                                 // 258: temporal.api.workflowservice.v1.CountSchedulesResponse.AggregationGroup
	(*UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersion)(nil),         // 259: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.AddNewCompatibleVersion
	(*UpdateWorkerBuildIdCompatibilityRequest_MergeSets)(nil),                       // 260: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.MergeSets
	(*UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRule)(nil),          // 261: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.InsertBuildIdAssignmentRule
	(*UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRule)(nil),         // 262: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceBuildIdAssignmentRule
	(*UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRule)(nil),          // 263: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteBuildIdAssignmentRule
	(*UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRule)(nil),     // 264: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.AddCompatibleBuildIdRedirectRule
	(*UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRule)(nil), // 265: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceCompatibleBuildIdRedirectRule
	(*UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRule)(nil),  // 266: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteCompatibleBuildIdRedirectRule
	(*UpdateWorkerVersioningRulesRequest_CommitBuildId)(nil),                        // 267: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.CommitBuildId
	(*ExecuteMultiOperationRequest_Operation)(nil),                                  // 268: temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation
	(*ExecuteMultiOperationResponse_Response)(nil),                                  // 269: temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response
	(*DescribeWorkerDeploymentVersionResponse_VersionTaskQueue)(nil),                // 270: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue
	nil, // 271: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.StatsByPriorityKeyEntry
	(*ListWorkerDeploymentsResponse_WorkerDeploymentSummary)(nil), // 272: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary
	nil, // 273: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry
	nil, // 274: temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry
	nil, // 275: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest.UpsertEntriesEntry
	(*UpdateTaskQueueConfigRequest_RateLimitUpdate)(nil), // 276: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.RateLimitUpdate
	nil, // 277: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.SetFairnessWeightOverridesEntry
	nil, // 278: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.NexusHeaderEntry
	(*CountActivityExecutionsResponse_AggregationGroup)(nil),        // 279: temporal.api.workflowservice.v1.CountActivityExecutionsResponse.AggregationGroup
	(*CountNexusOperationExecutionsResponse_AggregationGroup)(nil),  // 280: temporal.api.workflowservice.v1.CountNexusOperationExecutionsResponse.AggregationGroup
	(*durationpb.Duration)(nil),                                     // 281: google.protobuf.Duration
	(*v1.ClusterReplicationConfig)(nil),                             // 282: temporal.api.replication.v1.ClusterReplicationConfig
	(v11.ArchivalState)(0),                                          // 283: temporal.api.enums.v1.ArchivalState
	(*v12.NamespaceFilter)(nil),                                     // 284: temporal.api.namespace.v1.NamespaceFilter
	(*v12.NamespaceInfo)(nil),                                       // 285: temporal.api.namespace.v1.NamespaceInfo
	(*v12.NamespaceConfig)(nil),                                     // 286: temporal.api.namespace.v1.NamespaceConfig
	(*v1.NamespaceReplicationConfig)(nil),                           // 287: temporal.api.replication.v1.NamespaceReplicationConfig
	(*v1.FailoverStatus)(nil),                                       // 288: temporal.api.replication.v1.FailoverStatus
	(*v12.UpdateNamespaceInfo)(nil),                                 // 289: temporal.api.namespace.v1.UpdateNamespaceInfo
	(*v13.WorkflowType)(nil),                                        // 290: temporal.api.common.v1.WorkflowType
	(*v14.TaskQueue)(nil),                                           // 291: temporal.api.taskqueue.v1.TaskQueue
	(*v13.Payloads)(nil),                                            // 292: temporal.api.common.v1.Payloads
	(v11.WorkflowIdReusePolicy)(0),                                  // 293: temporal.api.enums.v1.WorkflowIdReusePolicy
	(v11.WorkflowIdConflictPolicy)(0),                               // 294: temporal.api.enums.v1.WorkflowIdConflictPolicy
	(*v13.RetryPolicy)(nil),                                         // 295: temporal.api.common.v1.RetryPolicy
	(*v13.Memo)(nil),                                                // 296: temporal.api.common.v1.Memo
	(*v13.SearchAttributes)(nil),                                    // 297: temporal.api.common.v1.SearchAttributes
	(*v13.Header)(nil),                                              // 298: temporal.api.common.v1.Header
	(*v15.Failure)(nil),                                             // 299: temporal.api.failure.v1.Failure
	(*v13.Callback)(nil),                                            // 300: temporal.api.common.v1.Callback
	(*v16.UserMetadata)(nil),                                        // 301: temporal.api.sdk.v1.UserMetadata
	(*v13.Link)(nil),                                                // 302: temporal.api.common.v1.Link
	(*v17.VersioningOverride)(nil),                                  // 303: temporal.api.workflow.v1.VersioningOverride
	(*v17.OnConflictOptions)(nil),                                   // 304: temporal.api.workflow.v1.OnConflictOptions
	(*v13.Priority)(nil),                                            // 305: temporal.api.common.v1.Priority
	(*v18.WorkerDeploymentOptions)(nil),                             // 306: temporal.api.deployment.v1.WorkerDeploymentOptions
	(*v17.TimeSkippingConfig)(nil),                                  // 307: temporal.api.workflow.v1.TimeSkippingConfig
	(v11.WorkflowExecutionStatus)(0),                                // 308: temporal.api.enums.v1.WorkflowExecutionStatus
	(*v13.WorkflowExecution)(nil),                                   // 309: temporal.api.common.v1.WorkflowExecution
	(v11.HistoryEventFilterType)(0),                                 // 310: temporal.api.enums.v1.HistoryEventFilterType
	(*v19.History)(nil),                                             // 311: temporal.api.history.v1.History
	(*v13.DataBlob)(nil),                                            // 312: temporal.api.common.v1.DataBlob
	(*v13.WorkerVersionCapabilities)(nil),                           // 313: temporal.api.common.v1.WorkerVersionCapabilities
	(*v110.WorkflowQuery)(nil),                                      // 314: temporal.api.query.v1.WorkflowQuery
	(*timestamppb.Timestamp)(nil),                                   // 315: google.protobuf.Timestamp
	(*v111.Message)(nil),                                            // 316: temporal.api.protocol.v1.Message
	(*v14.PollerScalingDecision)(nil),                               // 317: temporal.api.taskqueue.v1.PollerScalingDecision
	(*v14.PollerGroupInfo)(nil),                                     // 318: temporal.api.taskqueue.v1.PollerGroupInfo
	(*v112.Command)(nil),                                            // 319: temporal.api.command.v1.Command
	(*v14.StickyExecutionAttributes)(nil),                           // 320: temporal.api.taskqueue.v1.StickyExecutionAttributes
	(*v13.WorkerVersionStamp)(nil),                                  // 321: temporal.api.common.v1.WorkerVersionStamp
	(*v16.WorkflowTaskCompletedMetadata)(nil),                       // 322: temporal.api.sdk.v1.WorkflowTaskCompletedMetadata
	(*v13.MeteringMetadata)(nil),                                    // 323: temporal.api.common.v1.MeteringMetadata
	...
	(*v14.TaskQueueMetadata)(nil),                                   // 327: temporal.api.taskqueue.v1.TaskQueueMetadata
	(*v13.ActivityType)(nil),                                        // 328: temporal.api.common.v1.ActivityType
	(v11.ResetReapplyType)(0),                                       // 329: temporal.api.enums.v1.ResetReapplyType
	(v11.ResetReapplyExcludeType)(0),                                // 330: temporal.api.enums.v1.ResetReapplyExcludeType
	(*v17.PostResetOperation)(nil),                                  // 331: temporal.api.workflow.v1.PostResetOperation
	(*v113.StartTimeFilter)(nil),                                    // 332: temporal.api.filter.v1.StartTimeFilter
	(*v113.WorkflowExecutionFilter)(nil),                            // 333: temporal.api.filter.v1.WorkflowExecutionFilter
	(*v113.WorkflowTypeFilter)(nil),                                 // 334: temporal.api.filter.v1.WorkflowTypeFilter
	(*v17.WorkflowExecutionInfo)(nil),                               // 335: temporal.api.workflow.v1.WorkflowExecutionInfo
	(*v113.StatusFilter)(nil),                                       // 336: temporal.api.filter.v1.StatusFilter
	(v11.QueryResultType)(0),                                        // 337: temporal.api.enums.v1.QueryResultType
	(*v114.WorkerHeartbeat)(nil),                                    // 338: temporal.api.worker.v1.WorkerHeartbeat
	(v11.TaskQueueType)(0),                                          // 339: temporal.api.enums.v1.TaskQueueType
	(v11.QueryRejectCondition)(0),                                   // 340: temporal.api.enums.v1.QueryRejectCondition
	(*v110.QueryRejected)(nil),                                      // 341: temporal.api.query.v1.QueryRejected
	(*v17.WorkflowExecutionConfig)(nil),                             // 342: temporal.api.workflow.v1.WorkflowExecutionConfig
	(*v17.PendingActivityInfo)(nil),                                 // 343: temporal.api.workflow.v1.PendingActivityInfo
	(*v17.PendingChildExecutionInfo)(nil),                           // 344: temporal.api.workflow.v1.PendingChildExecutionInfo
	(*v17.PendingWorkflowTaskInfo)(nil),                             // 345: temporal.api.workflow.v1.PendingWorkflowTaskInfo
	(*v17.CallbackInfo)(nil),                                        // 346: temporal.api.workflow.v1.CallbackInfo
	(*v17.PendingNexusOperationInfo)(nil),                           // 347: temporal.api.workflow.v1.PendingNexusOperationInfo
	(*v17.WorkflowExecutionExtendedInfo)(nil),                       // 348: temporal.api.workflow.v1.WorkflowExecutionExtendedInfo
	(v11.DescribeTaskQueueMode)(0),                                  // 349: temporal.api.enums.v1.DescribeTaskQueueMode
	(*v14.TaskQueueVersionSelection)(nil),                           // 350: temporal.api.taskqueue.v1.TaskQueueVersionSelection
	(*v14.PollerInfo)(nil),                                          // 351: temporal.api.taskqueue.v1.PollerInfo
	(*v14.TaskQueueStats)(nil),                                      // 352: temporal.api.taskqueue.v1.TaskQueueStats
	(*v14.TaskQueueVersioningInfo)(nil),                             // 353: temporal.api.taskqueue.v1.TaskQueueVersioningInfo
	(*v14.TaskQueueConfig)(nil),                                     // 354: temporal.api.taskqueue.v1.TaskQueueConfig
	(*v14.TaskQueueStatus)(nil),                                     // 355: temporal.api.taskqueue.v1.TaskQueueStatus
	(*v115.VersionInfo)(nil),                                        // 356: temporal.api.version.v1.VersionInfo
	(*v14.TaskQueuePartitionMetadata)(nil),                          // 357: temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	(*v116.Schedule)(nil),                                           // 358: temporal.api.schedule.v1.Schedule
	(*v116.SchedulePatch)(nil),                                      // 359: temporal.api.schedule.v1.SchedulePatch
	(*v116.ScheduleInfo)(nil),                                       // 360: temporal.api.schedule.v1.ScheduleInfo
	(*v116.ScheduleListEntry)(nil),                                  // 361: temporal.api.schedule.v1.ScheduleListEntry
	(*v14.CompatibleVersionSet)(nil),                                // 362: temporal.api.taskqueue.v1.CompatibleVersionSet
	(*v14.TimestampedBuildIdAssignmentRule)(nil),                    // 363: temporal.api.taskqueue.v1.TimestampedBuildIdAssignmentRule
	(*v14.TimestampedCompatibleBuildIdRedirectRule)(nil),            // 364: temporal.api.taskqueue.v1.TimestampedCompatibleBuildIdRedirectRule
	(v11.TaskReachability)(0),                                       // 365: temporal.api.enums.v1.TaskReachability
	(*v14.BuildIdReachability)(nil),                                 // 366: temporal.api.taskqueue.v1.BuildIdReachability
	(*v117.WaitPolicy)(nil),                                         // 367: temporal.api.update.v1.WaitPolicy
	(*v117.Request)(nil),                                            // 368: temporal.api.update.v1.Request
	(*v117.UpdateRef)(nil),                                          // 369: temporal.api.update.v1.UpdateRef
	(*v117.Outcome)(nil),                                            // 370: temporal.api.update.v1.Outcome
	(v11.UpdateWorkflowExecutionLifecycleStage)(0),                  // 371: temporal.api.enums.v1.UpdateWorkflowExecutionLifecycleStage
	(*v118.BatchOperationTermination)(nil),                          // 372: temporal.api.batch.v1.BatchOperationTermination
	(*v118.BatchOperationSignal)(nil),                               // 373: temporal.api.batch.v1.BatchOperationSignal
	(*v118.BatchOperationCancellation)(nil),                         // 374: temporal.api.batch.v1.BatchOperationCancellation
	(*v118.BatchOperationDeletion)(nil),                             // 375: temporal.api.batch.v1.BatchOperationDeletion
	(*v118.BatchOperationReset)(nil),                                // 376: temporal.api.batch.v1.BatchOperationReset
	(*v118.BatchOperationUpdateWorkflowExecutionOptions)(nil),       // 377: temporal.api.batch.v1.BatchOperationUpdateWorkflowExecutionOptions
	(*v118.BatchOperationUnpauseActivities)(nil),                    // 378: temporal.api.batch.v1.BatchOperationUnpauseActivities
	(*v118.BatchOperationResetActivities)(nil),                      // 379: temporal.api.batch.v1.BatchOperationResetActivities
	(*v118.BatchOperationUpdateActivityOptions)(nil),                // 380: temporal.api.batch.v1.BatchOperationUpdateActivityOptions
	(v11.BatchOperationType)(0),                                     // 381: temporal.api.enums.v1.BatchOperationType
	(v11.BatchOperationState)(0),                                    // 382: temporal.api.enums.v1.BatchOperationState
	(*v118.BatchOperationInfo)(nil),                                 // 383: temporal.api.batch.v1.BatchOperationInfo
	(*v119.Request)(nil),                                            // 384: temporal.api.nexus.v1.Request
	(*v119.Response)(nil),                                           // 385: temporal.api.nexus.v1.Response
	(*v119.HandlerError)(nil),                                       // 386: temporal.api.nexus.v1.HandlerError
	(*v120.ActivityOptions)(nil),                                    // 387: temporal.api.activity.v1.ActivityOptions
	(*fieldmaskpb.FieldMask)(nil),                                   // 388: google.protobuf.FieldMask
	(*v17.WorkflowExecutionOptions)(nil),                            // 389: temporal.api.workflow.v1.WorkflowExecutionOptions
	(*v18.DeploymentInfo)(nil),                                      // 390: temporal.api.deployment.v1.DeploymentInfo
	(*v18.WorkerDeploymentVersion)(nil),                             // 391: temporal.api.deployment.v1.WorkerDeploymentVersion
	(*v18.WorkerDeploymentVersionInfo)(nil),                         // 392: temporal.api.deployment.v1.WorkerDeploymentVersionInfo
	(*v18.WorkerDeploymentInfo)(nil),                                // 393: temporal.api.deployment.v1.WorkerDeploymentInfo
	(*v18.DeploymentListInfo)(nil),                                  // 394: temporal.api.deployment.v1.DeploymentListInfo
	(*v18.UpdateDeploymentMetadata)(nil),                            // 395: temporal.api.deployment.v1.UpdateDeploymentMetadata
	(*v121.ComputeConfig)(nil),                                      // 396: temporal.api.compute.v1.ComputeConfig
	(*v18.VersionMetadata)(nil),                                     // 397: temporal.api.deployment.v1.VersionMetadata
	(v11.DeploymentReachability)(0),                                 // 398: temporal.api.enums.v1.DeploymentReachability
	(*v122.WorkflowRuleSpec)(nil),                                   // 399: temporal.api.rules.v1.WorkflowRuleSpec
	(*v122.WorkflowRule)(nil),                                       // 400: temporal.api.rules.v1.WorkflowRule
	(*v114.WorkerInfo)(nil),                                         // 401: temporal.api.worker.v1.WorkerInfo
	(*v114.WorkerListInfo)(nil),                                     // 402: temporal.api.worker.v1.WorkerListInfo
	(*v13.WorkerSelector)(nil),                                      // 403: temporal.api.common.v1.WorkerSelector
	(*v16.WorkerConfig)(nil),                                        // 404: temporal.api.sdk.v1.WorkerConfig
	...
	(*v13.OnConflictOptions)(nil),                                   // 407: temporal.api.common.v1.OnConflictOptions
	(*v120.ActivityExecutionInfo)(nil),                              // 408: temporal.api.activity.v1.ActivityExecutionInfo
	(*v120.ActivityExecutionOutcome)(nil),                           // 409: temporal.api.activity.v1.ActivityExecutionOutcome
	(*v120.CallbackInfo)(nil),                                       // 410: temporal.api.activity.v1.CallbackInfo
	(*v120.ActivityExecutionListInfo)(nil),                          // 411: temporal.api.activity.v1.ActivityExecutionListInfo
	(*v13.Payload)(nil),                                             // 412: temporal.api.common.v1.Payload
	(v11.NexusOperationIdReusePolicy)(0),                            // 413: temporal.api.enums.v1.NexusOperationIdReusePolicy
	(v11.NexusOperationIdConflictPolicy)(0),                         // 414: temporal.api.enums.v1.NexusOperationIdConflictPolicy
	(*v119.NexusOperationExecutionInfo)(nil),                        // 415: temporal.api.nexus.v1.NexusOperationExecutionInfo
	(v11.NexusOperationWaitStage)(0),                                // 416: temporal.api.enums.v1.NexusOperationWaitStage
	(*v119.NexusOperationExecutionListInfo)(nil),                    // 417: temporal.api.nexus.v1.NexusOperationExecutionListInfo
	(*v110.WorkflowQueryResult)(nil),                                // 418: temporal.api.query.v1.WorkflowQueryResult
	(v11.IndexedValueType)(0),                                       // 419: temporal.api.enums.v1.IndexedValueType
	(v11.RateLimitSource)(0),                                        // 420: temporal.api.enums.v1.RateLimitSource
	(*v14.TaskQueueVersionInfo)(nil),                                // 421: temporal.api.taskqueue.v1.TaskQueueVersionInfo
	(*v14.BuildIdAssignmentRule)(nil),                               // 422: temporal.api.taskqueue.v1.BuildIdAssignmentRule
	(*v14.CompatibleBuildIdRedirectRule)(nil),                       // 423: temporal.api.taskqueue.v1.CompatibleBuildIdRedirectRule
	(*v18.RoutingConfig)(nil),                                       // 424: temporal.api.deployment.v1.RoutingConfig
	(*v18.WorkerDeploymentInfo_WorkerDeploymentVersionSummary)(nil), // 425: temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary
	(*v121.ComputeConfigScalingGroupUpdate)(nil),                    // 426: temporal.api.compute.v1.ComputeConfigScalingGroupUpdate
	(*v14.RateLimit)(nil),                                           // 427: temporal.api.taskqueue.v1.RateLimit
}
var file_temporal_api_workflowservice_v1_request_response_proto_depIdxs = []int32{
	281, // 0: temporal.api.workflowservice.v1.RegisterNamespaceRequest.workflow_execution_retention_period:type_name -> google.protobuf.Duration
	282, // 1: temporal.api.workflowservice.v1.RegisterNamespaceRequest.clusters:type_name -> temporal.api.replication.v1.ClusterReplicationConfig
	244, // 2: temporal.api.workflowservice.v1.RegisterNamespaceRequest.data:type_name -> temporal.api.workflowservice.v1.RegisterNamespaceRequest.DataEntry
	283, // 3: temporal.api.workflowservice.v1.RegisterNamespaceRequest.history_archival_state:type_name -> temporal.api.enums.v1.ArchivalState
	283, // 4: temporal.api.workflowservice.v1.RegisterNamespaceRequest.visibility_archival_state:type_name -> temporal.api.enums.v1.ArchivalState
	284, // 5: temporal.api.workflowservice.v1.ListNamespacesRequest.namespace_filter:type_name -> temporal.api.namespace.v1.NamespaceFilter
	...
	285, // 7: temporal.api.workflowservice.v1.DescribeNamespaceResponse.namespace_info:type_name -> temporal.api.namespace.v1.NamespaceInfo
	286, // 8: temporal.api.workflowservice.v1.DescribeNamespaceResponse.config:type_name -> temporal.api.namespace.v1.NamespaceConfig
	287, // 9: temporal.api.workflowservice.v1.DescribeNamespaceResponse.replication_config:type_name -> temporal.api.replication.v1.NamespaceReplicationConfig
	288, // 10: temporal.api.workflowservice.v1.DescribeNamespaceResponse.failover_history:type_name -> temporal.api.replication.v1.FailoverStatus
	289, // 11: temporal.api.workflowservice.v1.UpdateNamespaceRequest.update_info:type_name -> temporal.api.namespace.v1.UpdateNamespaceInfo
	286, // 12: temporal.api.workflowservice.v1.UpdateNamespaceRequest.config:type_name -> temporal.api.namespace.v1.NamespaceConfig
	287, // 13: temporal.api.workflowservice.v1.UpdateNamespaceRequest.replication_config:type_name -> temporal.api.replication.v1.NamespaceReplicationConfig
	285, // 14: temporal.api.workflowservice.v1.UpdateNamespaceResponse.namespace_info:type_name -> temporal.api.namespace.v1.NamespaceInfo
	286, // 15: temporal.api.workflowservice.v1.UpdateNamespaceResponse.config:type_name -> temporal.api.namespace.v1.NamespaceConfig
	287, // 16: temporal.api.workflowservice.v1.UpdateNamespaceResponse.replication_config:type_name -> temporal.api.replication.v1.NamespaceReplicationConfig
	290, // 17: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	291, // 18: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	292, // 19: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.input:type_name -> temporal.api.common.v1.Payloads
	281, // 20: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_execution_timeout:type_name -> google.protobuf.Duration
	281, // 21: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_run_timeout:type_name -> google.protobuf.Duration
	281, // 22: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_task_timeout:type_name -> google.protobuf.Duration
	293, // 23: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_id_reuse_policy:type_name -> temporal.api.enums.v1.WorkflowIdReusePolicy
	294, // 24: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_id_conflict_policy:type_name -> temporal.api.enums.v1.WorkflowIdConflictPolicy
	295, // 25: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	296, // 26: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.memo:type_name -> temporal.api.common.v1.Memo
	297, // 27: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	298, // 28: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.header:type_name -> temporal.api.common.v1.Header
	299, // 29: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.continued_failure:type_name -> temporal.api.failure.v1.Failure
	292, // 30: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.last_completion_result:type_name -> temporal.api.common.v1.Payloads
	281, // 31: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.workflow_start_delay:type_name -> google.protobuf.Duration
	300, // 32: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.completion_callbacks:type_name -> temporal.api.common.v1.Callback
	301, // 33: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.user_metadata:type_name -> temporal.api.sdk.v1.UserMetadata
	302, // 34: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	303, // 35: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.versioning_override:type_name -> temporal.api.workflow.v1.VersioningOverride
	304, // 36: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.on_conflict_options:type_name -> temporal.api.workflow.v1.OnConflictOptions
	305, // 37: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.priority:type_name -> temporal.api.common.v1.Priority
	306, // 38: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.eager_worker_deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	307, // 39: temporal.api.workflowservice.v1.StartWorkflowExecutionRequest.time_skipping_config:type_name -> temporal.api.workflow.v1.TimeSkippingConfig
	308, // 40: temporal.api.workflowservice.v1.StartWorkflowExecutionResponse.status:type_name -> temporal.api.enums.v1.WorkflowExecutionStatus
	...
	302, // 42: temporal.api.workflowservice.v1.StartWorkflowExecutionResponse.link:type_name -> temporal.api.common.v1.Link
	309, // 43: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	310, // 44: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryRequest.history_event_filter_type:type_name -> temporal.api.enums.v1.HistoryEventFilterType
	311, // 45: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryResponse.history:type_name -> temporal.api.history.v1.History
	312, // 46: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryResponse.raw_history:type_name -> temporal.api.common.v1.DataBlob
	309, // 47: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	311, // 48: temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseResponse.history:type_name -> temporal.api.history.v1.History
	291, // 49: temporal.api.workflowservice.v1.PollWorkflowTaskQueueRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	313, // 50: temporal.api.workflowservice.v1.PollWorkflowTaskQueueRequest.worker_version_capabilities:type_name -> temporal.api.common.v1.WorkerVersionCapabilities
	306, // 51: temporal.api.workflowservice.v1.PollWorkflowTaskQueueRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	309, // 52: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	290, // 53: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	311, // 54: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.history:type_name -> temporal.api.history.v1.History
	314, // 55: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.query:type_name -> temporal.api.query.v1.WorkflowQuery
	291, // 56: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.workflow_execution_task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	315, // 57: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.scheduled_time:type_name -> google.protobuf.Timestamp
	315, // 58: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.started_time:type_name -> google.protobuf.Timestamp
	245, // 59: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.queries:type_name -> temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry
	316, // 60: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.messages:type_name -> temporal.api.protocol.v1.Message
	317, // 61: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.poller_scaling_decision:type_name -> temporal.api.taskqueue.v1.PollerScalingDecision
	318, // 62: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.poller_group_infos:type_name -> temporal.api.taskqueue.v1.PollerGroupInfo
	319, // 63: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.commands:type_name -> temporal.api.command.v1.Command
	320, // 64: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.sticky_attributes:type_name -> temporal.api.taskqueue.v1.StickyExecutionAttributes
	246, // 65: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.query_results:type_name -> temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.QueryResultsEntry
	321, // 66: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.worker_version_stamp:type_name -> temporal.api.common.v1.WorkerVersionStamp
	316, // 67: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.messages:type_name -> temporal.api.protocol.v1.Message
	322, // 68: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.sdk_metadata:type_name -> temporal.api.sdk.v1.WorkflowTaskCompletedMetadata
	323, // 69: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.metering_metadata:type_name -> temporal.api.common.v1.MeteringMetadata
	247, // 70: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.capabilities:type_name -> temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.Capabilities
	324, // 71: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	325, // 72: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.versioning_behavior:type_name -> temporal.api.enums.v1.VersioningBehavior
	306, // 73: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	...
	326, // 76: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.cause:type_name -> temporal.api.enums.v1.WorkflowTaskFailedCause
	299, // 77: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.failure:type_name -> temporal.api.failure.v1.Failure
	316, // 78: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.messages:type_name -> temporal.api.protocol.v1.Message
	321, // 79: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.worker_version:type_name -> temporal.api.common.v1.WorkerVersionStamp
	324, // 80: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	306, // 81: temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	291, // 82: temporal.api.workflowservice.v1.PollActivityTaskQueueRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	327, // 83: temporal.api.workflowservice.v1.PollActivityTaskQueueRequest.task_queue_metadata:type_name -> temporal.api.taskqueue.v1.TaskQueueMetadata
	313, // 84: temporal.api.workflowservice.v1.PollActivityTaskQueueRequest.worker_version_capabilities:type_name -> temporal.api.common.v1.WorkerVersionCapabilities
	306, // 85: temporal.api.workflowservice.v1.PollActivityTaskQueueRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	290, // 86: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	309, // 87: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	328, // 88: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.activity_type:type_name -> temporal.api.common.v1.ActivityType
	298, // 89: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.header:type_name -> temporal.api.common.v1.Header
	292, // 90: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.input:type_name -> temporal.api.common.v1.Payloads
	292, // 91: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.heartbeat_details:type_name -> temporal.api.common.v1.Payloads
	315, // 92: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.scheduled_time:type_name -> google.protobuf.Timestamp
	315, // 93: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.current_attempt_scheduled_time:type_name -> google.protobuf.Timestamp
	315, // 94: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.started_time:type_name -> google.protobuf.Timestamp
	281, // 95: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	281, // 96: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.start_to_close_timeout:type_name -> google.protobuf.Duration
	281, // 97: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.heartbeat_timeout:type_name -> google.protobuf.Duration
	295, // 98: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	317, // 99: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.poller_scaling_decision:type_name -> temporal.api.taskqueue.v1.PollerScalingDecision
	305, // 100: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.priority:type_name -> temporal.api.common.v1.Priority
	318, // 101: temporal.api.workflowservice.v1.PollActivityTaskQueueResponse.poller_group_infos:type_name -> temporal.api.taskqueue.v1.PollerGroupInfo
	292, // 102: temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatRequest.details:type_name -> temporal.api.common.v1.Payloads
	292, // 103: temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdRequest.details:type_name -> temporal.api.common.v1.Payloads
	292, // 104: temporal.api.workflowservice.v1.RespondActivityTaskCompletedRequest.result:type_name -> temporal.api.common.v1.Payloads
	321, // 105: temporal.api.workflowservice.v1.RespondActivityTaskCompletedRequest.worker_version:type_name -> temporal.api.common.v1.WorkerVersionStamp
	324, // 106: temporal.api.workflowservice.v1.RespondActivityTaskCompletedRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	306, // 107: temporal.api.workflowservice.v1.RespondActivityTaskCompletedRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	292, // 108: temporal.api.workflowservice.v1.RespondActivityTaskCompletedByIdRequest.result:type_name -> temporal.api.common.v1.Payloads
	299, // 109: temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest.failure:type_name -> temporal.api.failure.v1.Failure
	292, // 110: temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest.last_heartbeat_details:type_name -> temporal.api.common.v1.Payloads
	321, // 111: temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest.worker_version:type_name -> temporal.api.common.v1.WorkerVersionStamp
	324, // 112: temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	306, // 113: temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	299, // 114: temporal.api.workflowservice.v1.RespondActivityTaskFailedResponse.failures:type_name -> temporal.api.failure.v1.Failure
	299, // 115: temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdRequest.failure:type_name -> temporal.api.failure.v1.Failure
	292, // 116: temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdRequest.last_heartbeat_details:type_name -> temporal.api.common.v1.Payloads
	299, // 117: temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdResponse.failures:type_name -> temporal.api.failure.v1.Failure
	292, // 118: temporal.api.workflowservice.v1.RespondActivityTaskCanceledRequest.details:type_name -> temporal.api.common.v1.Payloads
	321, // 119: temporal.api.workflowservice.v1.RespondActivityTaskCanceledRequest.worker_version:type_name -> temporal.api.common.v1.WorkerVersionStamp
	324, // 120: temporal.api.workflowservice.v1.RespondActivityTaskCanceledRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	306, // 121: temporal.api.workflowservice.v1.RespondActivityTaskCanceledRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	292, // 122: temporal.api.workflowservice.v1.RespondActivityTaskCanceledByIdRequest.details:type_name -> temporal.api.common.v1.Payloads
	306, // 123: temporal.api.workflowservice.v1.RespondActivityTaskCanceledByIdRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	309, // 124: temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	302, // 125: temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	309, // 126: temporal.api.workflowservice.v1.SignalWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	292, // 127: temporal.api.workflowservice.v1.SignalWorkflowExecutionRequest.input:type_name -> temporal.api.common.v1.Payloads
	298, // 128: temporal.api.workflowservice.v1.SignalWorkflowExecutionRequest.header:type_name -> temporal.api.common.v1.Header
	302, // 129: temporal.api.workflowservice.v1.SignalWorkflowExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	302, // 130: temporal.api.workflowservice.v1.SignalWorkflowExecutionResponse.link:type_name -> temporal.api.common.v1.Link
	290, // 131: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_type:type_name -> temporal.api.common.v1.WorkflowType
	291, // 132: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	292, // 133: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.input:type_name -> temporal.api.common.v1.Payloads
	281, // 134: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_execution_timeout:type_name -> google.protobuf.Duration
	281, // 135: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_run_timeout:type_name -> google.protobuf.Duration
	281, // 136: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_task_timeout:type_name -> google.protobuf.Duration
	293, // 137: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_id_reuse_policy:type_name -> temporal.api.enums.v1.WorkflowIdReusePolicy
	294, // 138: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_id_conflict_policy:type_name -> temporal.api.enums.v1.WorkflowIdConflictPolicy
	292, // 139: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.signal_input:type_name -> temporal.api.common.v1.Payloads
	295, // 140: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	296, // 141: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.memo:type_name -> temporal.api.common.v1.Memo
	297, // 142: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	298, // 143: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.header:type_name -> temporal.api.common.v1.Header
	281, // 144: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.workflow_start_delay:type_name -> google.protobuf.Duration
	301, // 145: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.user_metadata:type_name -> temporal.api.sdk.v1.UserMetadata
	302, // 146: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	303, // 147: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.versioning_override:type_name -> temporal.api.workflow.v1.VersioningOverride
	305, // 148: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.priority:type_name -> temporal.api.common.v1.Priority
	307, // 149: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest.time_skipping_config:type_name -> temporal.api.workflow.v1.TimeSkippingConfig
	302, // 150: temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse.signal_link:type_name -> temporal.api.common.v1.Link
	309, // 151: temporal.api.workflowservice.v1.ResetWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	329, // 152: temporal.api.workflowservice.v1.ResetWorkflowExecutionRequest.reset_reapply_type:type_name -> temporal.api.enums.v1.ResetReapplyType
	330, // 153: temporal.api.workflowservice.v1.ResetWorkflowExecutionRequest.reset_reapply_exclude_types:type_name -> temporal.api.enums.v1.ResetReapplyExcludeType
	331, // 154: temporal.api.workflowservice.v1.ResetWorkflowExecutionRequest.post_reset_operations:type_name -> temporal.api.workflow.v1.PostResetOperation
	309, // 155: temporal.api.workflowservice.v1.TerminateWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	292, // 156: temporal.api.workflowservice.v1.TerminateWorkflowExecutionRequest.details:type_name -> temporal.api.common.v1.Payloads
	302, // 157: temporal.api.workflowservice.v1.TerminateWorkflowExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	309, // 158: temporal.api.workflowservice.v1.DeleteWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	332, // 159: temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsRequest.start_time_filter:type_name -> temporal.api.filter.v1.StartTimeFilter
	333, // 160: temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsRequest.execution_filter:type_name -> temporal.api.filter.v1.WorkflowExecutionFilter
	334, // 161: temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsRequest.type_filter:type_name -> temporal.api.filter.v1.WorkflowTypeFilter
	335, // 162: temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsResponse.executions:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	332, // 163: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsRequest.start_time_filter:type_name -> temporal.api.filter.v1.StartTimeFilter
	333, // 164: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsRequest.execution_filter:type_name -> temporal.api.filter.v1.WorkflowExecutionFilter
	334, // 165: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsRequest.type_filter:type_name -> temporal.api.filter.v1.WorkflowTypeFilter
	336, // 166: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsRequest.status_filter:type_name -> temporal.api.filter.v1.StatusFilter
	335, // 167: temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsResponse.executions:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	335, // 168: temporal.api.workflowservice.v1.ListWorkflowExecutionsResponse.executions:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	335, // 169: temporal.api.workflowservice.v1.ListArchivedWorkflowExecutionsResponse.executions:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	335, // 170: temporal.api.workflowservice.v1.ScanWorkflowExecutionsResponse.executions:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	248, // 171: temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse.groups:type_name -> temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse.AggregationGroup
	249, // 172: temporal.api.workflowservice.v1.GetSearchAttributesResponse.keys:type_name -> temporal.api.workflowservice.v1.GetSearchAttributesResponse.KeysEntry
	337, // 173: temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest.completed_type:type_name -> temporal.api.enums.v1.QueryResultType
	292, // 174: temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest.query_result:type_name -> temporal.api.common.v1.Payloads
	299, // 175: temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest.failure:type_name -> temporal.api.failure.v1.Failure
	326, // 176: temporal.api.workflowservice.v1.RespondQueryTaskCompletedRequest.cause:type_name -> temporal.api.enums.v1.WorkflowTaskFailedCause
	309, // 177: temporal.api.workflowservice.v1.ResetStickyTaskQueueRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	338, // 178: temporal.api.workflowservice.v1.ShutdownWorkerRequest.worker_heartbeat:type_name -> temporal.api.worker.v1.WorkerHeartbeat
	339, // 179: temporal.api.workflowservice.v1.ShutdownWorkerRequest.task_queue_types:type_name -> temporal.api.enums.v1.TaskQueueType
	309, // 180: temporal.api.workflowservice.v1.QueryWorkflowRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	314, // 181: temporal.api.workflowservice.v1.QueryWorkflowRequest.query:type_name -> temporal.api.query.v1.WorkflowQuery
	340, // 182: temporal.api.workflowservice.v1.QueryWorkflowRequest.query_reject_condition:type_name -> temporal.api.enums.v1.QueryRejectCondition
	292, // 183: temporal.api.workflowservice.v1.QueryWorkflowResponse.query_result:type_name -> temporal.api.common.v1.Payloads
	341, // 184: temporal.api.workflowservice.v1.QueryWorkflowResponse.query_rejected:type_name -> temporal.api.query.v1.QueryRejected
	309, // 185: temporal.api.workflowservice.v1.DescribeWorkflowExecutionRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	342, // 186: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.execution_config:type_name -> temporal.api.workflow.v1.WorkflowExecutionConfig
	335, // 187: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.workflow_execution_info:type_name -> temporal.api.workflow.v1.WorkflowExecutionInfo
	343, // 188: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.pending_activities:type_name -> temporal.api.workflow.v1.PendingActivityInfo
	344, // 189: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.pending_children:type_name -> temporal.api.workflow.v1.PendingChildExecutionInfo
	345, // 190: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.pending_workflow_task:type_name -> temporal.api.workflow.v1.PendingWorkflowTaskInfo
	346, // 191: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.callbacks:type_name -> temporal.api.workflow.v1.CallbackInfo
	347, // 192: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.pending_nexus_operations:type_name -> temporal.api.workflow.v1.PendingNexusOperationInfo
	348, // 193: temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse.workflow_extended_info:type_name -> temporal.api.workflow.v1.WorkflowExecutionExtendedInfo
	309, // 194: temporal.api.workflowservice.v1.GetWorkflowExecutionResultRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	300, // 195: temporal.api.workflowservice.v1.GetWorkflowExecutionResultRequest.completion_callbacks:type_name -> temporal.api.common.v1.Callback
	302, // 196: temporal.api.workflowservice.v1.GetWorkflowExecutionResultRequest.links:type_name -> temporal.api.common.v1.Link
	309, // 197: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	302, // 198: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.links:type_name -> temporal.api.common.v1.Link
	250, // 199: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.running:type_name -> temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Running
	251, // 200: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.success:type_name -> temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Success
	252, // 201: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.failed:type_name -> temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Failed
	291, // 202: temporal.api.workflowservice.v1.DescribeTaskQueueRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	339, // 203: temporal.api.workflowservice.v1.DescribeTaskQueueRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	349, // 204: temporal.api.workflowservice.v1.DescribeTaskQueueRequest.api_mode:type_name -> temporal.api.enums.v1.DescribeTaskQueueMode
	350, // 205: temporal.api.workflowservice.v1.DescribeTaskQueueRequest.versions:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionSelection
	339, // 206: temporal.api.workflowservice.v1.DescribeTaskQueueRequest.task_queue_types:type_name -> temporal.api.enums.v1.TaskQueueType
	351, // 207: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.pollers:type_name -> temporal.api.taskqueue.v1.PollerInfo
	352, // 208: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.stats:type_name -> temporal.api.taskqueue.v1.TaskQueueStats
	253, // 209: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.stats_by_priority_key:type_name -> temporal.api.workflowservice.v1.DescribeTaskQueueResponse.StatsByPriorityKeyEntry
	353, // 210: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.versioning_info:type_name -> temporal.api.taskqueue.v1.TaskQueueVersioningInfo
	354, // 211: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.config:type_name -> temporal.api.taskqueue.v1.TaskQueueConfig
	254, // 212: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.effective_rate_limit:type_name -> temporal.api.workflowservice.v1.DescribeTaskQueueResponse.EffectiveRateLimit
	355, // 213: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.task_queue_status:type_name -> temporal.api.taskqueue.v1.TaskQueueStatus
	255, // 214: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.versions_info:type_name -> temporal.api.workflowservice.v1.DescribeTaskQueueResponse.VersionsInfoEntry
	256, // 215: temporal.api.workflowservice.v1.GetClusterInfoResponse.supported_clients:type_name -> temporal.api.workflowservice.v1.GetClusterInfoResponse.SupportedClientsEntry
	356, // 216: temporal.api.workflowservice.v1.GetClusterInfoResponse.version_info:type_name -> temporal.api.version.v1.VersionInfo
	257, // 217: temporal.api.workflowservice.v1.GetSystemInfoResponse.capabilities:type_name -> temporal.api.workflowservice.v1.GetSystemInfoResponse.Capabilities
	291, // 218: temporal.api.workflowservice.v1.ListTaskQueuePartitionsRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	357, // 219: temporal.api.workflowservice.v1.ListTaskQueuePartitionsResponse.activity_task_queue_partitions:type_name -> temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	357, // 220: temporal.api.workflowservice.v1.ListTaskQueuePartitionsResponse.workflow_task_queue_partitions:type_name -> temporal.api.taskqueue.v1.TaskQueuePartitionMetadata
	358, // 221: temporal.api.workflowservice.v1.CreateScheduleRequest.schedule:type_name -> temporal.api.schedule.v1.Schedule
	359, // 222: temporal.api.workflowservice.v1.CreateScheduleRequest.initial_patch:type_name -> temporal.api.schedule.v1.SchedulePatch
	296, // 223: temporal.api.workflowservice.v1.CreateScheduleRequest.memo:type_name -> temporal.api.common.v1.Memo
	297, // 224: temporal.api.workflowservice.v1.CreateScheduleRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	358, // 225: temporal.api.workflowservice.v1.DescribeScheduleResponse.schedule:type_name -> temporal.api.schedule.v1.Schedule
	360, // 226: temporal.api.workflowservice.v1.DescribeScheduleResponse.info:type_name -> temporal.api.schedule.v1.ScheduleInfo
	296, // 227: temporal.api.workflowservice.v1.DescribeScheduleResponse.memo:type_name -> temporal.api.common.v1.Memo
	297, // 228: temporal.api.workflowservice.v1.DescribeScheduleResponse.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	358, // 229: temporal.api.workflowservice.v1.UpdateScheduleRequest.schedule:type_name -> temporal.api.schedule.v1.Schedule
	297, // 230: temporal.api.workflowservice.v1.UpdateScheduleRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	296, // 231: temporal.api.workflowservice.v1.UpdateScheduleRequest.memo:type_name -> temporal.api.common.v1.Memo
	359, // 232: temporal.api.workflowservice.v1.PatchScheduleRequest.patch:type_name -> temporal.api.schedule.v1.SchedulePatch
	315, // 233: temporal.api.workflowservice.v1.ListScheduleMatchingTimesRequest.start_time:type_name -> google.protobuf.Timestamp
	315, // 234: temporal.api.workflowservice.v1.ListScheduleMatchingTimesRequest.end_time:type_name -> google.protobuf.Timestamp
	315, // 235: temporal.api.workflowservice.v1.ListScheduleMatchingTimesResponse.start_time:type_name -> google.protobuf.Timestamp
	361, // 236: temporal.api.workflowservice.v1.ListSchedulesResponse.schedules:type_name -> temporal.api.schedule.v1.ScheduleListEntry
	258, // 237: temporal.api.workflowservice.v1.CountSchedulesResponse.groups:type_name -> temporal.api.workflowservice.v1.CountSchedulesResponse.AggregationGroup
	259, // 238: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.add_new_compatible_build_id:type_name -> temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.AddNewCompatibleVersion
	260, // 239: temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.merge_sets:type_name -> temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.MergeSets
	362, // 240: temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse.major_version_sets:type_name -> temporal.api.taskqueue.v1.CompatibleVersionSet
	261, // 241: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.insert_assignment_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.InsertBuildIdAssignmentRule
	262, // 242: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.replace_assignment_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceBuildIdAssignmentRule
	263, // 243: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.delete_assignment_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteBuildIdAssignmentRule
	264, // 244: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.add_compatible_redirect_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.AddCompatibleBuildIdRedirectRule
	265, // 245: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.replace_compatible_redirect_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceCompatibleBuildIdRedirectRule
	266, // 246: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.delete_compatible_redirect_rule:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteCompatibleBuildIdRedirectRule
	267, // 247: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.commit_build_id:type_name -> temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.CommitBuildId
	363, // 248: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse.assignment_rules:type_name -> temporal.api.taskqueue.v1.TimestampedBuildIdAssignmentRule
	364, // 249: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse.compatible_redirect_rules:type_name -> temporal.api.taskqueue.v1.TimestampedCompatibleBuildIdRedirectRule
	363, // 250: temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse.assignment_rules:type_name -> temporal.api.taskqueue.v1.TimestampedBuildIdAssignmentRule
	364, // 251: temporal.api.workflowservice.v1.GetWorkerVersioningRulesResponse.compatible_redirect_rules:type_name -> temporal.api.taskqueue.v1.TimestampedCompatibleBuildIdRedirectRule
	365, // 252: temporal.api.workflowservice.v1.GetWorkerTaskReachabilityRequest.reachability:type_name -> temporal.api.enums.v1.TaskReachability
	366, // 253: temporal.api.workflowservice.v1.GetWorkerTaskReachabilityResponse.build_id_reachability:type_name -> temporal.api.taskqueue.v1.BuildIdReachability
	309, // 254: temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	367, // 255: temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest.wait_policy:type_name -> temporal.api.update.v1.WaitPolicy
	368, // 256: temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest.request:type_name -> temporal.api.update.v1.Request
	369, // 257: temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse.update_ref:type_name -> temporal.api.update.v1.UpdateRef
	370, // 258: temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse.outcome:type_name -> temporal.api.update.v1.Outcome
	371, // 259: temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse.stage:type_name -> temporal.api.enums.v1.UpdateWorkflowExecutionLifecycleStage
	309, // 260: temporal.api.workflowservice.v1.StartBatchOperationRequest.executions:type_name -> temporal.api.common.v1.WorkflowExecution
	372, // 261: temporal.api.workflowservice.v1.StartBatchOperationRequest.termination_operation:type_name -> temporal.api.batch.v1.BatchOperationTermination
	373, // 262: temporal.api.workflowservice.v1.StartBatchOperationRequest.signal_operation:type_name -> temporal.api.batch.v1.BatchOperationSignal
	374, // 263: temporal.api.workflowservice.v1.StartBatchOperationRequest.cancellation_operation:type_name -> temporal.api.batch.v1.BatchOperationCancellation
	375, // 264: temporal.api.workflowservice.v1.StartBatchOperationRequest.deletion_operation:type_name -> temporal.api.batch.v1.BatchOperationDeletion
	376, // 265: temporal.api.workflowservice.v1.StartBatchOperationRequest.reset_operation:type_name -> temporal.api.batch.v1.BatchOperationReset
	377, // 266: temporal.api.workflowservice.v1.StartBatchOperationRequest.update_workflow_options_operation:type_name -> temporal.api.batch.v1.BatchOperationUpdateWorkflowExecutionOptions
	378, // 267: temporal.api.workflowservice.v1.StartBatchOperationRequest.unpause_activities_operation:type_name -> temporal.api.batch.v1.BatchOperationUnpauseActivities
	379, // 268: temporal.api.workflowservice.v1.StartBatchOperationRequest.reset_activities_operation:type_name -> temporal.api.batch.v1.BatchOperationResetActivities
	380, // 269: temporal.api.workflowservice.v1.StartBatchOperationRequest.update_activity_options_operation:type_name -> temporal.api.batch.v1.BatchOperationUpdateActivityOptions
	381, // 270: temporal.api.workflowservice.v1.DescribeBatchOperationResponse.operation_type:type_name -> temporal.api.enums.v1.BatchOperationType
	382, // 271: temporal.api.workflowservice.v1.DescribeBatchOperationResponse.state:type_name -> temporal.api.enums.v1.BatchOperationState
	315, // 272: temporal.api.workflowservice.v1.DescribeBatchOperationResponse.start_time:type_name -> google.protobuf.Timestamp
	315, // 273: temporal.api.workflowservice.v1.DescribeBatchOperationResponse.close_time:type_name -> google.protobuf.Timestamp
	383, // 274: temporal.api.workflowservice.v1.ListBatchOperationsResponse.operation_info:type_name -> temporal.api.batch.v1.BatchOperationInfo
	369, // 275: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest.update_ref:type_name -> temporal.api.update.v1.UpdateRef
	367, // 276: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest.wait_policy:type_name -> temporal.api.update.v1.WaitPolicy
	370, // 277: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse.outcome:type_name -> temporal.api.update.v1.Outcome
	371, // 278: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse.stage:type_name -> temporal.api.enums.v1.UpdateWorkflowExecutionLifecycleStage
	369, // 279: temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse.update_ref:type_name -> temporal.api.update.v1.UpdateRef
	291, // 280: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	313, // 281: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest.worker_version_capabilities:type_name -> temporal.api.common.v1.WorkerVersionCapabilities
	306, // 282: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest.deployment_options:type_name -> temporal.api.deployment.v1.WorkerDeploymentOptions
	338, // 283: temporal.api.workflowservice.v1.PollNexusTaskQueueRequest.worker_heartbeat:type_name -> temporal.api.worker.v1.WorkerHeartbeat
	384, // 284: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse.request:type_name -> temporal.api.nexus.v1.Request
	317, // 285: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse.poller_scaling_decision:type_name -> temporal.api.taskqueue.v1.PollerScalingDecision
	318, // 286: temporal.api.workflowservice.v1.PollNexusTaskQueueResponse.poller_group_infos:type_name -> temporal.api.taskqueue.v1.PollerGroupInfo
	385, // 287: temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest.response:type_name -> temporal.api.nexus.v1.Response
	386, // 288: temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest.error:type_name -> temporal.api.nexus.v1.HandlerError
	299, // 289: temporal.api.workflowservice.v1.RespondNexusTaskFailedRequest.failure:type_name -> temporal.api.failure.v1.Failure
	268, // 290: temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.operations:type_name -> temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation
	269, // 291: temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.responses:type_name -> temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response
	309, // 292: temporal.api.workflowservice.v1.UpdateActivityOptionsRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	387, // 293: temporal.api.workflowservice.v1.UpdateActivityOptionsRequest.activity_options:type_name -> temporal.api.activity.v1.ActivityOptions
	388, // 294: temporal.api.workflowservice.v1.UpdateActivityOptionsRequest.update_mask:type_name -> google.protobuf.FieldMask
	387, // 295: temporal.api.workflowservice.v1.UpdateActivityExecutionOptionsRequest.activity_options:type_name -> temporal.api.activity.v1.ActivityOptions
	388, // 296: temporal.api.workflowservice.v1.UpdateActivityExecutionOptionsRequest.update_mask:type_name -> google.protobuf.FieldMask
	387, // 297: temporal.api.workflowservice.v1.UpdateActivityOptionsResponse.activity_options:type_name -> temporal.api.activity.v1.ActivityOptions
	387, // 298: temporal.api.workflowservice.v1.UpdateActivityExecutionOptionsResponse.activity_options:type_name -> temporal.api.activity.v1.ActivityOptions
	309, // 299: temporal.api.workflowservice.v1.PauseActivityRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	309, // 300: temporal.api.workflowservice.v1.UnpauseActivityRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	281, // 301: temporal.api.workflowservice.v1.UnpauseActivityRequest.jitter:type_name -> google.protobuf.Duration
	281, // 302: temporal.api.workflowservice.v1.UnpauseActivityExecutionRequest.jitter:type_name -> google.protobuf.Duration
	309, // 303: temporal.api.workflowservice.v1.ResetActivityRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	281, // 304: temporal.api.workflowservice.v1.ResetActivityRequest.jitter:type_name -> google.protobuf.Duration
	281, // 305: temporal.api.workflowservice.v1.ResetActivityExecutionRequest.jitter:type_name -> google.protobuf.Duration
	309, // 306: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest.workflow_execution:type_name -> temporal.api.common.v1.WorkflowExecution
	389, // 307: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest.workflow_execution_options:type_name -> temporal.api.workflow.v1.WorkflowExecutionOptions
	388, // 308: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest.update_mask:type_name -> google.protobuf.FieldMask
	389, // 309: temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsResponse.workflow_execution_options:type_name -> temporal.api.workflow.v1.WorkflowExecutionOptions
	324, // 310: temporal.api.workflowservice.v1.DescribeDeploymentRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	390, // 311: temporal.api.workflowservice.v1.DescribeDeploymentResponse.deployment_info:type_name -> temporal.api.deployment.v1.DeploymentInfo
	391, // 312: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	392, // 313: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.worker_deployment_version_info:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersionInfo
	270, // 314: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.version_task_queues:type_name -> temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue
	393, // 315: temporal.api.workflowservice.v1.DescribeWorkerDeploymentResponse.worker_deployment_info:type_name -> temporal.api.deployment.v1.WorkerDeploymentInfo
	394, // 316: temporal.api.workflowservice.v1.ListDeploymentsResponse.deployments:type_name -> temporal.api.deployment.v1.DeploymentListInfo
	324, // 317: temporal.api.workflowservice.v1.SetCurrentDeploymentRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	395, // 318: temporal.api.workflowservice.v1.SetCurrentDeploymentRequest.update_metadata:type_name -> temporal.api.deployment.v1.UpdateDeploymentMetadata
	390, // 319: temporal.api.workflowservice.v1.SetCurrentDeploymentResponse.current_deployment_info:type_name -> temporal.api.deployment.v1.DeploymentInfo
	390, // 320: temporal.api.workflowservice.v1.SetCurrentDeploymentResponse.previous_deployment_info:type_name -> temporal.api.deployment.v1.DeploymentInfo
	391, // 321: temporal.api.workflowservice.v1.SetWorkerDeploymentCurrentVersionResponse.previous_deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	391, // 322: temporal.api.workflowservice.v1.SetWorkerDeploymentRampingVersionResponse.previous_deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	272, // 323: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.worker_deployments:type_name -> temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary
	391, // 324: temporal.api.workflowservice.v1.CreateWorkerDeploymentVersionRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	396, // 325: temporal.api.workflowservice.v1.CreateWorkerDeploymentVersionRequest.compute_config:type_name -> temporal.api.compute.v1.ComputeConfig
	391, // 326: temporal.api.workflowservice.v1.DeleteWorkerDeploymentVersionRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	391, // 327: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	273, // 328: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest.compute_config_scaling_groups:type_name -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry
	391, // 329: temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	274, // 330: temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigRequest.compute_config_scaling_groups:type_name -> temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry
	391, // 331: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest.deployment_version:type_name -> temporal.api.deployment.v1.WorkerDeploymentVersion
	275, // 332: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest.upsert_entries:type_name -> temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest.UpsertEntriesEntry
	397, // 333: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataResponse.metadata:type_name -> temporal.api.deployment.v1.VersionMetadata
	390, // 334: temporal.api.workflowservice.v1.GetCurrentDeploymentResponse.current_deployment_info:type_name -> temporal.api.deployment.v1.DeploymentInfo
	324, // 335: temporal.api.workflowservice.v1.GetDeploymentReachabilityRequest.deployment:type_name -> temporal.api.deployment.v1.Deployment
	390, // 336: temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse.deployment_info:type_name -> temporal.api.deployment.v1.DeploymentInfo
	398, // 337: temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse.reachability:type_name -> temporal.api.enums.v1.DeploymentReachability
	315, // 338: temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse.last_update_time:type_name -> google.protobuf.Timestamp
	399, // 339: temporal.api.workflowservice.v1.CreateWorkflowRuleRequest.spec:type_name -> temporal.api.rules.v1.WorkflowRuleSpec
	400, // 340: temporal.api.workflowservice.v1.CreateWorkflowRuleResponse.rule:type_name -> temporal.api.rules.v1.WorkflowRule
	400, // 341: temporal.api.workflowservice.v1.DescribeWorkflowRuleResponse.rule:type_name -> temporal.api.rules.v1.WorkflowRule
	400, // 342: temporal.api.workflowservice.v1.ListWorkflowRulesResponse.rules:type_name -> temporal.api.rules.v1.WorkflowRule
	309, // 343: temporal.api.workflowservice.v1.TriggerWorkflowRuleRequest.execution:type_name -> temporal.api.common.v1.WorkflowExecution
	399, // 344: temporal.api.workflowservice.v1.TriggerWorkflowRuleRequest.spec:type_name -> temporal.api.rules.v1.WorkflowRuleSpec
	338, // 345: temporal.api.workflowservice.v1.RecordWorkerHeartbeatRequest.worker_heartbeat:type_name -> temporal.api.worker.v1.WorkerHeartbeat
	401, // 346: temporal.api.workflowservice.v1.ListWorkersResponse.workers_info:type_name -> temporal.api.worker.v1.WorkerInfo
	402, // 347: temporal.api.workflowservice.v1.ListWorkersResponse.workers:type_name -> temporal.api.worker.v1.WorkerListInfo
	339, // 348: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.task_queue_type:type_name -> temporal.api.enums.v1.TaskQueueType
	276, // 349: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.update_queue_rate_limit:type_name -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.RateLimitUpdate
	276, // 350: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.update_fairness_key_rate_limit_default:type_name -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.RateLimitUpdate
	277, // 351: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.set_fairness_weight_overrides:type_name -> temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.SetFairnessWeightOverridesEntry
	354, // 352: temporal.api.workflowservice.v1.UpdateTaskQueueConfigResponse.config:type_name -> temporal.api.taskqueue.v1.TaskQueueConfig
	403, // 353: temporal.api.workflowservice.v1.FetchWorkerConfigRequest.selector:type_name -> temporal.api.common.v1.WorkerSelector
	404, // 354: temporal.api.workflowservice.v1.FetchWorkerConfigResponse.worker_config:type_name -> temporal.api.sdk.v1.WorkerConfig
	404, // 355: temporal.api.workflowservice.v1.UpdateWorkerConfigRequest.worker_config:type_name -> temporal.api.sdk.v1.WorkerConfig
	388, // 356: temporal.api.workflowservice.v1.UpdateWorkerConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	403, // 357: temporal.api.workflowservice.v1.UpdateWorkerConfigRequest.selector:type_name -> temporal.api.common.v1.WorkerSelector
	404, // 358: temporal.api.workflowservice.v1.UpdateWorkerConfigResponse.worker_config:type_name -> temporal.api.sdk.v1.WorkerConfig
	401, // 359: temporal.api.workflowservice.v1.DescribeWorkerResponse.worker_info:type_name -> temporal.api.worker.v1.WorkerInfo
	328, // 360: temporal.api.workflowservice.v1.StartActivityExecutionRequest.activity_type:type_name -> temporal.api.common.v1.ActivityType
	291, // 361: temporal.api.workflowservice.v1.StartActivityExecutionRequest.task_queue:type_name -> temporal.api.taskqueue.v1.TaskQueue
	281, // 362: temporal.api.workflowservice.v1.StartActivityExecutionRequest.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	281, // 363: temporal.api.workflowservice.v1.StartActivityExecutionRequest.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	281, // 364: temporal.api.workflowservice.v1.StartActivityExecutionRequest.start_to_close_timeout:type_name -> google.protobuf.Duration
	281, // 365: temporal.api.workflowservice.v1.StartActivityExecutionRequest.heartbeat_timeout:type_name -> google.protobuf.Duration
	295, // 366: temporal.api.workflowservice.v1.StartActivityExecutionRequest.retry_policy:type_name -> temporal.api.common.v1.RetryPolicy
	292, // 367: temporal.api.workflowservice.v1.StartActivityExecutionRequest.input:type_name -> temporal.api.common.v1.Payloads
	405, // 368: temporal.api.workflowservice.v1.StartActivityExecutionRequest.id_reuse_policy:type_name -> temporal.api.enums.v1.ActivityIdReusePolicy
	406, // 369: temporal.api.workflowservice.v1.StartActivityExecutionRequest.id_conflict_policy:type_name -> temporal.api.enums.v1.ActivityIdConflictPolicy
	297, // 370: temporal.api.workflowservice.v1.StartActivityExecutionRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	298, // 371: temporal.api.workflowservice.v1.StartActivityExecutionRequest.header:type_name -> temporal.api.common.v1.Header
	301, // 372: temporal.api.workflowservice.v1.StartActivityExecutionRequest.user_metadata:type_name -> temporal.api.sdk.v1.UserMetadata
	305, // 373: temporal.api.workflowservice.v1.StartActivityExecutionRequest.priority:type_name -> temporal.api.common.v1.Priority
	300, // 374: temporal.api.workflowservice.v1.StartActivityExecutionRequest.completion_callbacks:type_name -> temporal.api.common.v1.Callback
	302, // 375: temporal.api.workflowservice.v1.StartActivityExecutionRequest.links:type_name -> temporal.api.common.v1.Link
	407, // 376: temporal.api.workflowservice.v1.StartActivityExecutionRequest.on_conflict_options:type_name -> temporal.api.common.v1.OnConflictOptions
	281, // 377: temporal.api.workflowservice.v1.StartActivityExecutionRequest.start_delay:type_name -> google.protobuf.Duration
	302, // 378: temporal.api.workflowservice.v1.StartActivityExecutionResponse.link:type_name -> temporal.api.common.v1.Link
	408, // 379: temporal.api.workflowservice.v1.DescribeActivityExecutionResponse.info:type_name -> temporal.api.activity.v1.ActivityExecutionInfo
	292, // 380: temporal.api.workflowservice.v1.DescribeActivityExecutionResponse.input:type_name -> temporal.api.common.v1.Payloads
	409, // 381: temporal.api.workflowservice.v1.DescribeActivityExecutionResponse.outcome:type_name -> temporal.api.activity.v1.ActivityExecutionOutcome
	410, // 382: temporal.api.workflowservice.v1.DescribeActivityExecutionResponse.callbacks:type_name -> temporal.api.activity.v1.CallbackInfo
	409, // 383: temporal.api.workflowservice.v1.PollActivityExecutionResponse.outcome:type_name -> temporal.api.activity.v1.ActivityExecutionOutcome
	411, // 384: temporal.api.workflowservice.v1.ListActivityExecutionsResponse.executions:type_name -> temporal.api.activity.v1.ActivityExecutionListInfo
	281, // 385: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.schedule_to_close_timeout:type_name -> google.protobuf.Duration
	281, // 386: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.schedule_to_start_timeout:type_name -> google.protobuf.Duration
	281, // 387: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.start_to_close_timeout:type_name -> google.protobuf.Duration
	412, // 388: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.input:type_name -> temporal.api.common.v1.Payload
	413, // 389: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.id_reuse_policy:type_name -> temporal.api.enums.v1.NexusOperationIdReusePolicy
	414, // 390: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.id_conflict_policy:type_name -> temporal.api.enums.v1.NexusOperationIdConflictPolicy
	297, // 391: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.search_attributes:type_name -> temporal.api.common.v1.SearchAttributes
	278, // 392: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.nexus_header:type_name -> temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.NexusHeaderEntry
	301, // 393: temporal.api.workflowservice.v1.StartNexusOperationExecutionRequest.user_metadata:type_name -> temporal.api.sdk.v1.UserMetadata
	415, // 394: temporal.api.workflowservice.v1.DescribeNexusOperationExecutionResponse.info:type_name -> temporal.api.nexus.v1.NexusOperationExecutionInfo
	412, // 395: temporal.api.workflowservice.v1.DescribeNexusOperationExecutionResponse.input:type_name -> temporal.api.common.v1.Payload
	412, // 396: temporal.api.workflowservice.v1.DescribeNexusOperationExecutionResponse.result:type_name -> temporal.api.common.v1.Payload
	299, // 397: temporal.api.workflowservice.v1.DescribeNexusOperationExecutionResponse.failure:type_name -> temporal.api.failure.v1.Failure
	416, // 398: temporal.api.workflowservice.v1.PollNexusOperationExecutionRequest.wait_stage:type_name -> temporal.api.enums.v1.NexusOperationWaitStage
	416, // 399: temporal.api.workflowservice.v1.PollNexusOperationExecutionResponse.wait_stage:type_name -> temporal.api.enums.v1.NexusOperationWaitStage
	412, // 400: temporal.api.workflowservice.v1.PollNexusOperationExecutionResponse.result:type_name -> temporal.api.common.v1.Payload
	299, // 401: temporal.api.workflowservice.v1.PollNexusOperationExecutionResponse.failure:type_name -> temporal.api.failure.v1.Failure
	417, // 402: temporal.api.workflowservice.v1.ListNexusOperationExecutionsResponse.operations:type_name -> temporal.api.nexus.v1.NexusOperationExecutionListInfo
	279, // 403: temporal.api.workflowservice.v1.CountActivityExecutionsResponse.groups:type_name -> temporal.api.workflowservice.v1.CountActivityExecutionsResponse.AggregationGroup
	280, // 404: temporal.api.workflowservice.v1.CountNexusOperationExecutionsResponse.groups:type_name -> temporal.api.workflowservice.v1.CountNexusOperationExecutionsResponse.AggregationGroup
	314, // 405: temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse.QueriesEntry.value:type_name -> temporal.api.query.v1.WorkflowQuery
	418, // 406: temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.QueryResultsEntry.value:type_name -> temporal.api.query.v1.WorkflowQueryResult
	412, // 407: temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse.AggregationGroup.group_values:type_name -> temporal.api.common.v1.Payload
	419, // 408: temporal.api.workflowservice.v1.GetSearchAttributesResponse.KeysEntry.value:type_name -> temporal.api.enums.v1.IndexedValueType
	292, // 409: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Success.result:type_name -> temporal.api.common.v1.Payloads
	299, // 410: temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse.Failed.failure:type_name -> temporal.api.failure.v1.Failure
	352, // 411: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.StatsByPriorityKeyEntry.value:type_name -> temporal.api.taskqueue.v1.TaskQueueStats
	420, // 412: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.EffectiveRateLimit.rate_limit_source:type_name -> temporal.api.enums.v1.RateLimitSource
	421, // 413: temporal.api.workflowservice.v1.DescribeTaskQueueResponse.VersionsInfoEntry.value:type_name -> temporal.api.taskqueue.v1.TaskQueueVersionInfo
	412, // 414: temporal.api.workflowservice.v1.CountSchedulesResponse.AggregationGroup.group_values:type_name -> temporal.api.common.v1.Payload
	422, // 415: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.InsertBuildIdAssignmentRule.rule:type_name -> temporal.api.taskqueue.v1.BuildIdAssignmentRule
	422, // 416: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceBuildIdAssignmentRule.rule:type_name -> temporal.api.taskqueue.v1.BuildIdAssignmentRule
	423, // 417: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.AddCompatibleBuildIdRedirectRule.rule:type_name -> temporal.api.taskqueue.v1.CompatibleBuildIdRedirectRule
	423, // 418: temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceCompatibleBuildIdRedirectRule.rule:type_name -> temporal.api.taskqueue.v1.CompatibleBuildIdRedirectRule
	10,  // 419: temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation.start_workflow:type_name -> temporal.api.workflowservice.v1.StartWorkflowExecutionRequest
	112, // 420: temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation.update_workflow:type_name -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest
	11,  // 421: temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response.start_workflow:type_name -> temporal.api.workflowservice.v1.StartWorkflowExecutionResponse
	113, // 422: temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response.update_workflow:type_name -> temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse
	339, // 423: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.type:type_name -> temporal.api.enums.v1.TaskQueueType
	352, // 424: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.stats:type_name -> temporal.api.taskqueue.v1.TaskQueueStats
	271, // 425: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.stats_by_priority_key:type_name -> temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.StatsByPriorityKeyEntry
	352, // 426: temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue.StatsByPriorityKeyEntry.value:type_name -> temporal.api.taskqueue.v1.TaskQueueStats
	315, // 427: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary.create_time:type_name -> google.protobuf.Timestamp
	424, // 428: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary.routing_config:type_name -> temporal.api.deployment.v1.RoutingConfig
	425, // 429: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary.latest_version_summary:type_name -> temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary
	425, // 430: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary.current_version_summary:type_name -> temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary
	425, // 431: temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary.ramping_version_summary:type_name -> temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary
	426, // 432: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry.value:type_name -> temporal.api.compute.v1.ComputeConfigScalingGroupUpdate
	426, // 433: temporal.api.workflowservice.v1.ValidateWorkerDeploymentVersionComputeConfigRequest.ComputeConfigScalingGroupsEntry.value:type_name -> temporal.api.compute.v1.ComputeConfigScalingGroupUpdate
	412, // 434: temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest.UpsertEntriesEntry.value:type_name -> temporal.api.common.v1.Payload
	427, // 435: temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.RateLimitUpdate.rate_limit:type_name -> temporal.api.taskqueue.v1.RateLimit
	412, // 436: temporal.api.workflowservice.v1.CountActivityExecutionsResponse.AggregationGroup.group_values:type_name -> temporal.api.common.v1.Payload
	412, // 437: temporal.api.workflowservice.v1.CountNexusOperationExecutionsResponse.AggregationGroup.group_values:type_name -> temporal.api.common.v1.Payload
...
func file_temporal_api_workflowservice_v1_request_response_proto_init() {
	...
	file_temporal_api_workflowservice_v1_request_response_proto_msgTypes[77].OneofWrappers = []any{
		(*GetWorkflowExecutionResultResponse_Running_)(nil),
		(*GetWorkflowExecutionResultResponse_Success_)(nil),
		(*GetWorkflowExecutionResultResponse_Failed_)(nil),
	}

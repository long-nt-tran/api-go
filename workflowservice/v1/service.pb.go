...
const file_temporal_api_workflowservice_v1_service_proto_rawDesc = "" +
	"\n" +
	"-temporal/api/workflowservice/v1/service.proto\x12\x1ftemporal.api.workflowservice.v1\x1a6temporal/api/workflowservice/v1/request_response.proto\x1a\x1cgoogle/api/annotations.proto\x1a+temporal/api/protometa/v1/annotations.proto2\xac\xb0\x02\n" +
	...
	"\x1dDeleteNexusOperationExecution\x12E.temporal.api.workflowservice.v1.DeleteNexusOperationExecutionRequest\x1aF.temporal.api.workflowservice.v1.DeleteNexusOperationExecutionResponse\"\x00\x12\xf9\x02\n" +
	"\x1aGetWorkflowExecutionResult\x12B.temporal.api.workflowservice.v1.GetWorkflowExecutionResultRequest\x1aC.temporal.api.workflowservice.v1.GetWorkflowExecutionResultResponse\"\xd1\x01\x8a\x9d\xcc\x1b8\n" +
	"\x14temporal-resource-id\x12 workflow:{execution.workflow_id}\x82\xd3\xe4\x93\x02\x8d\x01ZI\x12G/api/v1/namespaces/{namespace}/workflows/{execution.workflow_id}/result\x12@/namespaces/{namespace}/workflows/{execution.workflow_id}/resultB\xb6\x01\n" +

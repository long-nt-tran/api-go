...
type NamespaceInfo_Capabilities struct {
	...
	WorkflowUpdateCallbacks bool `protobuf:"varint,11,opt,name=workflow_update_callbacks,json=workflowUpdateCallbacks,proto3" json:"workflow_update_callbacks,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *NamespaceInfo_Capabilities) GetWorkflowUpdateCallbacks() bool {
	if x != nil {
		return x.WorkflowUpdateCallbacks
	}
	return false
}
...
const file_temporal_api_namespace_v1_message_proto_rawDesc = "" +
	"\n" +
	"'temporal/api/namespace/v1/message.proto\x12\x19temporal.api.namespace.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a%temporal/api/enums/v1/namespace.proto\"\xb0\t\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a\xb6\x04\n" +
	"\fCapabilities\x120\n" +
	...
	"\x19workflow_update_callbacks\x18\v \x01(\bR\x17workflowUpdateCallbacks\x1an\n" +
	"\x06Limits\x121\n" +
